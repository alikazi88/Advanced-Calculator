...
ee = Button(mainFrame, text="pi", fg="black",image=eeimage, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton(eie)).grid(row=5, column=3, columnspan=2, padx=1, pady=1)
...
eigen_btn = PhotoImage(file = r"images\eigen.png")
eigen_image = eigen_btn.subsample(4,4)
eigen_btn = Button(mainFrame, text="eigen", fg="black",image=eigen_image, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("eigen(")).grid(row=6, column=3, padx=1, pady=1)
...
log_btn = Button(mainFrame, text="log", fg="black",image=log_btnimage, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("log(")).grid(row=6, column=4, padx=1, pady=1)

limit_btn = PhotoImage(file = r"images\limit.png")
limit_image = limit_btn.subsample(4,4)
limit_btn = Button(mainFrame, text="limit", fg="black",image=limit_image, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("log(")).grid(row=7, column=1, padx=1, pady=1)

expo_btn = PhotoImage(file = r"images\exponential.png")
expo_image = expo_btn.subsample(4,4)
expo_btn = Button(mainFrame, text="exponential", fg="black",image=expo_image, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("exp(")).grid(row=7, column=2, padx=1, pady=1)

mean_btn = PhotoImage(file = r"images\mean.png")
mean_image = mean_btn.subsample(4,4)
mean_btn = Button(mainFrame, text="mean", fg="black",image=mean_image, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("mean(")).grid(row=7, column=3, padx=1, pady=1)

mode_btn = PhotoImage(file = r"images\Mode.png")
mode_image = mode_btn.subsample(4,4)
mode_btn = Button(mainFrame, text="mode", fg="black",image=mode_image, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("mode(")).grid(row=7, column=4, padx=1, pady=1)

median_btn = PhotoImage(file = r"images\median.png")
median_image = median_btn.subsample(4,4)
median_btn = Button(mainFrame, text="median", fg="black",image=median_image, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("med(")).grid(row=1, column=4, padx=1, pady=1)

logistic_btn = PhotoImage(file = r"images\logistic.png")
logistic_image = logistic_btn.subsample(4,4)
logistic_btn = Button(mainFrame, text="logistic", fg="black",image=logistic_image, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("logistic(")).grid(row=2, column=4, padx=1, pady=1)

linear_btn = PhotoImage(file = r"images\linear.png")
linear_image = linear_btn.subsample(4,4)
linear_btn = Button(mainFrame, text="linear", fg="black",image=linear_image, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("lin(")).grid(row=3, column=4, padx=1, pady=1)

standard_btn = PhotoImage(file = r"images\standard.png")
standard_image = standard_btn.subsample(4,4)
standard_btn = Button(mainFrame, text="standard", fg="black",image=standard_image, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("std(")).grid(row=4, column=4, padx=1, pady=1)

matrice_btn = PhotoImage(file = r"images\matrice.png")
matrice_image = matrice_btn.subsample(4,4)
matrice_btn = Button(mainFrame, text="log", fg="black",image=matrice_image, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("log(")).grid(row=7, column=0, padx=1, pady=1)

deter_btn = PhotoImage(file = r"images\determinant.png")
deter_image = deter_btn.subsample(4,4)
deter_btn = Button(mainFrame, text="determinant", fg="black",image=deter_image, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("deter(")).grid(row=0, column=4, padx=1, pady=1)
